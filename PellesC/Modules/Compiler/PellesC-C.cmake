...
if (CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 11.0)
  if (CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 12.0)
    ...
    # PellesC 11.00.3 has `-std=c2x`, but `__STDC_VERSION__=202912L`. By docs
    # `-std=c17` is default, but `__STDC_VERSION__=202912L` without arguments.

    set(CMAKE_C_STANDARD_COMPUTED_DEFAULT 11)  # Force explicit setting

    set(CMAKE_C23_STANDARD_COMPILE_OPTION -std=c2x)
    set(CMAKE_C23_EXTENSION_COMPILE_OPTION -std=c2x -Zx)
  endif ()
